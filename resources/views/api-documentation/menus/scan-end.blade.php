...
<div class="overflow-hidden content-section" id="content-{{ $menuKey }}">
	<h2>{{ $menuName }}</h2>
	<p>
		End an existing scanning session.<br>
		If the result is successful the program returns the date and time of the ending.
	</p>
	...
	<p>The keys belongs to the ended scanning. The information about the keys are listed in section 'Details Of Items / Scanning'.</p>
</div>